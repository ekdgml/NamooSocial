...
<body>
	...
	<div class="container">
		<div class="no-gutter row">
			...
			<div class="col-md-2">
				<div class="panel panel-default" id="sidebar">
					...
					<div class="panel-body">
						...
						<img class="img-responsive" src="${ctx}/main/writerPhoto/${notFollowing.userId}" />
						<p>${notFollowing.name}&nbsp;&nbsp;&nbsp;${notFollowing.userId}</p>
						&nbsp;<input type="button"onclick="location.href='${ctx}/follow/${notFollowing.userId}'"value="팔로우" class="btn btn-default" /><br/>
						</c:forEach>
			...
			<div class="panel-body">
				<div class="well"> 
                     <form class="form-horizontal" role="form" action="${ctx}/posting" method="post" enctype="multipart/form-data">
                      <h4>공유하기</h4>
                       ...
                       <button class="btn btn-default" type="submit">공유</button>&nbsp;
						<input type="file" class="image" name="imageFile" placeholder="사진불러오기"/>
                    </form>
                </div>
					</div>
				</div>
				...
				<div class="panel">
					...
					<p id="allMessages"></p>
						...
						<c:forEach var="message" items="${messages}">
							<div class="row">
								<div class="col-md-8">
									<img class="img-responsive" src="${ctx}/main/writerPhoto/${message.writer.userId}" />
									<h4>${message.writer.name}</h4>&nbsp;
									<button class="btn btn-default" onclick="location.href='${ctx}/remove/${message.id}'">삭제</button>&nbsp;
									<h5>${message.writer.userId}&nbsp;${message.reg_dt}</h5>
									<c:if test="${message.imageId != null}">
										<img class="img-responsive" src="${ctx}/main/upload/${message.imageId}" />
									</c:if>
