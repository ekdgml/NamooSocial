...
public class MessageServiceTest extends AbstractDbUnitTestCase{
	//
	...
	public void testShowTimeLine() {
		...
		//assertion
		assertThat(messages.get(2).getContents(), is("First message"));
		assertThat(messages.get(2).getWriter().getUserId(), is("ekdgml"));
		assertThat(messages.get(2).getWriter().getName(), is("박상희"));
